    ...
    <div className="min-h-screen gradient-soft flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-purple-600">Create Account</h1>
          <p className="text-muted-foreground mt-2">Start keeping track of your memories</p>
        </div>
